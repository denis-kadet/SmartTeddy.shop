...
class WC_Gateway_Amazon_Payments_Advanced extends WC_Gateway_Amazon_Payments_Advanced_Abstract
{
    ...
    public function init_handlers()
    {
        ...
        add_action('woocommerce_checkout_after_customer_details', array($this, 'checkout_message'), 5);
    ...
    {
        ?>
        <p class="wc-apa-button-separator">
            &mdash; <?php esc_html_e('OR', 'woocommerce-gateway-amazon-payments-advanced'); ?> &mdash;</p>
        <?php
    }
    ...
    public function checkout_message()
    {
        ...
        if ($this->is_available()) {
            $class[] = 'wc-amazon-payments-advanced-populate';
        }
        $class = implode(' ', $class);
        ...
        if ($this->is_available()) {
            if (!$this->is_logged_in()) {
                echo '<div class="amazon__text-sub_btn">' . apply_filters('woocommerce_amazon_pa_checkout_message', __('Have an Amazon account?', 'woocommerce-gateway-amazon-payments-advanced')) . '</div><div class="woocommerce-info info wc-amazon-payments-advanced-info">' . $this->checkout_button(false) . '</div>';
            } else {
    ...
    public function logout_checkout_message()
    {
        ...
        $logout_msg_html = '<div class="woocommerce-info info woocommerce-info__text">' . apply_filters('woocommerce_amazon_pa_checkout_logout_message', __('You\'re logged in with your Amazon Account.', 'woocommerce-gateway-amazon-payments-advanced')) . ' <a href="' . esc_url($logout_url) . '" id="amazon-logout" class="amazon-logout__link">' . __('Log out', 'woocommerce-gateway-amazon-payments-advanced') . '</a></div>';
    ...
    public function display_payment_method_selected($checkout_session = null)
    {
        ...
        <div id="payment_method_widget">
            ...
            ?>
            <div class="shipping_address_widget-wrap">
                <h3 class="checkbox__title-wrap">
                    <?php esc_html_e('2. Payment Method', 'woocommerce-gateway-amazon-payments-advanced'); ?>
                </h3>
                <div class="shipping_address_widget-link">
    ...
    public function display_shipping_address_selected($checkout_session = null)
    {
        ...
        if (!empty($checkout_session->shippingAddress)) : // phpcs:ignore WordPress.NamingConventions
            ...
            <div id="shipping_address_widget">
                <div class="shipping_address_widget-wrap">
                    <h3 class="checkbox__title-wrap">
                        <?php esc_html_e('1. Shipping Address', 'woocommerce-gateway-amazon-payments-advanced'); ?>
                    </h3>
                    <div class="shipping_address_widget-link">
    ...
    public function display_amazon_customer_info()
    {
        ...
        ?>
        <div id="amazon_customer_details" class="wc-amazon-payments-advanced-populated col-lg-8">
            <div class="row">

                <div class="col-lg-12 <?php echo empty($checkout_session->shippingAddress) ? 'hidden' : ''; ?>">
    ...
    public function update_js()
    {
        ...
        ?>
        <script type="text/template" id="wc-apa-update-vals"
                data-value="<?php echo esc_attr(wp_json_encode($data)); ?>"></script>
        <?php
    }
